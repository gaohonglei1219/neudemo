...
<header class="header">
	<a href="index" class="logo"
		style="text-align: left;background-color:#f4f4f4;"> <!-- Add the class icon to your logo image or logo icon to add the margining -->
		<img src="../images/logo22.png"> </a>
	<!-- Header Navbar: style can be found in header.less -->
	<nav class="navbar navbar-static-top" role="navigation"
		style="background-color: #00789d;">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <i
						class="glyphicon glyphicon-user"></i> <span class="userName"
						id="user_name1">Jane Doe <i class="caret"></i>
					</span> </a>
					<ul class="dropdown-menu">
						...
						<li class="user-header bg-light-blue"><img
							...
							<p>
								<span id="user_name2">Jane Doe</span>
							</p></li>
						<!-- Menu Body -->
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="/OnlineBank/bank/signout_admin.do"
