				...
				<div class="col-md-11">
					...
					<div class="box box-danger">
                        ...
                        <div class="col-lg-3 col-xs-6">
						 ...
						 <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs pull-right">
                                    ...
                                    <a href="#tab_1-1" data-toggle="tab">活期转定期</a>
                                    ...
                                    <li>
                                    <a href="#tab_2-2" data-toggle="tab">定期转活期</a>
                                    </li>
                                    <li>
                                    <a href="#tab_3-3" data-toggle="tab">约定定期</a>
                                    </li>
                                    <li>
                                    <a href="#tab_4-4" data-toggle="tab">约定零存整取</a>
                                    </li>
						...
						<div class="box-header">
							...
							<button style="float:right;margin-right:20px;" class="btn btn-primary btn-sm"  data-toggle="modal" data-backdrop="static"  data-target="#compose-modal">
								购买定期金融产品
							</button>
                ...
                <div class="modal-content">
                    <div class="modal-header">
						...
						<div class="box-header">
							...
							<span style="margin-left: 30px;" id="KName_info"></span> 
							</td>
							 ...
							 <div class="box-footer clearfix">
                                ...
                                <div class="box" id="div3" style="display:none" >
									<div class="box-header">
										...
										<span style="margin-left: 140px;" id="KName_info"></span> 
										<button style="float:right; padding-left:30px; padding-right:30px;" class="btn btn-primary btn-sm" onClick="hiddencc();">
								         上拉
							            </button>
									</div>
									<!-- /.box-header -->
							 ...
							 <div class="box-footer clearfix">
                                ...
                                <div class="box" id="div4" style="display:none" >
									<div class="box-header">
										...
										<span style="margin-left: 140px;" id="KName_info"></span> 
										<button style="float:right; padding-left:30px; padding-right:30px;" class="btn btn-primary btn-sm" onClick="hiddenl();">
								         上拉
							            </button>
									</div>
									<!-- /.box-header -->
