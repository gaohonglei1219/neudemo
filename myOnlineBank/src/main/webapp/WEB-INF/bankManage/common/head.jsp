  ...
  <nav class="navbar navbar-static-top" role="navigation"> 
    ...
    <div class="navbar-right">
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu">
            ...
            <li> 
              ...
              <ul class="menu">
                <li><!-- start message --> 
                  <a href="#">
                  <div class="pull-left"> <img src="<%=request.getContextPath()%>/bankManage/img/avatar3.png" class="img-circle" alt="User Image"/> </div>
                  <h4> Support Team <small><i class="fa fa-clock-o"></i> 5 mins</small> </h4>
                  <p>Why not buy a new awesome theme?</p>
                  </a> </li>
                <!-- end message -->
                <li> <a href="#">
                  <div class="pull-left"> <img src="<%=request.getContextPath()%>/bankManageimg/avatar2.png" class="img-circle" alt="user image"/> </div>
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span>${ sessionScope.admin.username} <i class="caret"></i></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header bg-light-blue"> <img src="<%=request.getContextPath()%>/bankManage/img/avatar3.png" class="img-circle" alt="User Image" />
            ...
            <li class="user-footer">
              ...
              <div class="pull-right"> <a href="/OnlineBank/bankManage/signout_admin" class="btn btn-default btn-flat">退出</a> </div>
            </li>
          </ul>
        </li>
      </ul>
