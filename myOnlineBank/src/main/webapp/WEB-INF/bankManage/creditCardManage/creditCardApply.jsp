                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
						 <li><a href="#"><i class="fa fa-money"></i>信用卡业务</a></li>
                        <li class="active">申请信用卡</li>
                    </ol>
                </section>
					...
					<div class="row">
							...
							<div class="col-lg-11">
								<form id="addCreditCard" action="" method="post">
								 ...
								 <div class="modal-body">
									  		...
									  		<div class="col-lg-8">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input id="cardpassword" name="cardpassword" value="123" type="password" class="form-control" placeholder="请输入取款密码">
									  		...
									  		<div class="col-lg-8">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="cardpassword2" value="123" type="password" class="form-control" placeholder="请确认密码">
									...
									<div class="row">
										...
										<div class="row">
									  		<div class="col-lg-8">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input type="text" name="postcode" value="076983344477" class="form-control" placeholder="输入邮政编码">
										 ...
										 <div class="row">
										  		<div class="col-lg-8">
													 <div class="form-group">
								 							 <div class="input-group">
	                                           					<span class="input-group-addon">人民币额度：</span>
																<input value="5000" name="RMBQuota" type="text" class="form-control" placeholder="输入证件号码">
										...
										<input type="hidden" value="1" name="issigned" />
								...
								<div class="modal-footer clearfix">
									...
									<button type="reset"  style="padding-left: 30px; padding-right: 30px;" class="btn btn-danger pull-left" data-toggle="modal" data-backdrop="static" data-target="#myModal" ><i class="fa fa-times"></i> 重置</button>
								</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        $("#nav_creditCardManage_apply").addClass("active");
	});	
        	$(function(){
        		...
        		$("#province").change(function(){
          		...
          		$("#city").change(function(){
          			...
          			$("#addCreditCard input[name='obuserid']").val($(this).children('option:selected').attr('code'));
          			getNetwork(cityId);
        			...
        			$("#btn").click(function(){
        				...
        				if(result)
        				{
        					$(".loading").show();
        					$.ajax({
        		  				url:"/OnlineBank/bankManage/addCreditCard",
        		  				data:$("#addCreditCard").serialize(),
        		  				type:"POST",
        		  				dataType:"json",
        		...
        		var val =  $('#addCreditCard').validate({  
        	            errorElement : 'span',  
