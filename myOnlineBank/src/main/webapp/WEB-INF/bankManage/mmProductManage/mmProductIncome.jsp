						...
						<div class="col-lg-12">
						 ...
						 <div class="form-group">
							 	 <div class="input-group">
										...
										<input id="search_name" name="search_name" type="text" style="width: 480px;" class="form-control" >
									</div>
                           </div>
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="input-group" style="width: 480px;">
										<span type="text" name ="edit_name1" id="edit_name1" style="width: 180px; margin-right:10px;" >   </span>
										 <input name="financingid" id="financingid" type="text"  placeholder="不超过30字" style="display:none" >	 
                                   	...
                                   	<table class="table table-striped">
											...
											<tbody>
												 ...
												 <tr>
												<td  style="padding-top:15px;">实际回报</td><td > 
												 <input type="text" id="obFinancialincomes" name="obFinancialincomes" class="form-control" style="width: 80px; display:inline; margin-right:10px; " > 
												 </td>
												</tr>
...
$(function() {
        ...
        $("#nav_mmProductManage_income").addClass("active");
});
$(function() {	
...
url : '../list_product_editincome.do?id='+Integer+'',
type : 'POST',
...
//console.info(r.obFinancialincomes); 
//console.info(r.financingid); 
//console.info(r.financingname); 
$('#obFinancialincomes').val(r.obFinancialincomes);
$('#financingid').val(r.financingid);
...
$(function () {
    ...
    table = $('#table_id').DataTable({
         ...
         "aoColumns": [
				...
				{ "sTitle": "实际回报","sClass": "center", "mDataProp": "obFinancialincomes","bSearchable": false,"bSortable": false,
				"fnRender": function (obj) {
				if(obj.aData.obFinancialincomes==null)
				{return '<span>没有到收益日期</span>'}
				
				else
				return '<span>'+obj.aData.obFinancialincomes+' %</span>'
				}
				},
				...
				//	console.info(obj.aData.financingid);
					...
					return '<button onclick="editbuttion('+obj.aData.financingid+')" class="btn btn-primary btn-sm" data-toggle="modal" data-backdrop="static"  data-target="#compose-modal1" >修改回报</button>&nbsp;&nbsp;'
