  ...
  <div class="form-box form-boxbj" id="login-box" style="position: relative;">
    ...
    <div id="loginTip">
        ...
        <div class="form-group">
          ...
          <img  id ="img" src="getVerifyCode.do" class="img" width="100px" height="30px"
						onClick="this.src='getVerifyCode.do?'+Math.random()" />  </div>					
    ...
    <div class="margin text-center"> <span>使用以下账户登录</span> <br/>
