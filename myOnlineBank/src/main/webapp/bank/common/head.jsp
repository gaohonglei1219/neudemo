...
<header class="header"> <a href="../index.html" class="logo" style="text-align: left;"> 
  <!-- Add the class icon to your logo image or logo icon to add the margining --> 
  <img width="140px" height="36px" src="../images/logo.jpg"> </a> 
  ...
  <nav class="navbar navbar-static-top" role="navigation"> 
    ...
    <div class="navbar-right">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span class="userName" id="user_name1">Jane Doe <i class="caret"></i></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header bg-light-blue"> <img src="../img/avatar3.png" class="img-circle" alt="User Image" />
              <p> <span class="userName" id="user_name2">Jane Doe</span> - Web Developer <small>Member since Nov. 2012</small> </p>
            </li>
            <!-- Menu Body -->
            <li class="user-body">
            ...
            <li class="user-footer">
              ...
              <div class="pull-right"> <a href="/OnlineBank/bank/signout_admin.do" class="btn btn-default btn-flat">Sign out</a> </div>
            </li>
          </ul>
        </li>
      </ul>
