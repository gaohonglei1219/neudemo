...
<div class="logincontent" style="position: relative;">
  <div class="contentleft">
    <h1>欢迎来到 暴走银行。</h1>
    <p>加入暴走网银享受更多精彩，获取轻松自由便捷的理财体验，拥有不一样的视角。</p>
  </div>
  <div class="form-box form-boxbj" id="login-box" style="position: relative; width: 330px;">
    ...
    <div id="loginTip" style="font-size:14px;color:red">
        ...
        <div class="form-group">
		  <input name="code" id="code"  type="text" style="width:140px; float:left;"  class="form-control" placeholder="验证码"/>
          <div style="float:left;margin-left:15px;margin-top:2px;"> 
          <img  id ="img" src="getVerifyCode" class="img" width="70px" height="32px"
...
d.src="getVerifyCode?"+Math.random();
