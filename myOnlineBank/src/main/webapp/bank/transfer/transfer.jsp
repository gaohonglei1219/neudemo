...
<link rel="shortcut icon" href="http://img0.bdstatic.com/img/image/shouye/fstwlstqqq04.jpg">
									  		...
									  		<div class="col-lg-9">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="target"  type="text" class="form-control" placeholder="请输入收款人账号">
									  		...
									  		<div class="col-lg-9">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="targetName"  type="text" class="form-control" placeholder="请输入收款人姓名">
									  		...
									  		<div class="col-lg-9">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="bank"  type="text" class="form-control" placeholder="请输入收款人开户行">
									  		...
									  		<div class="col-lg-9">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="money"  type="text" class="form-control" placeholder="请输入转账金额">
									  		...
									  		<div class="col-lg-9">
												 <div class="form-group">
							 							 <div class="input-group">
															...
															<input name="summary" type="text" class="form-control" placeholder="请输入转账留言">
